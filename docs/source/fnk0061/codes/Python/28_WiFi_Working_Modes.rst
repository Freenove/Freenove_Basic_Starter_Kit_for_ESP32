...
Open "Thonny", click "This computer"  ->  "D:"  ->  "Micropython_Codes"  ->  "14.1_Station_mode" and double click "Station_mode.py". 
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/14.1_Station_mode/Station_mode.py
    :language: python
    :dedent:
...
Component List & Circuit are the same as in Section 16.1.
...
Open "Thonny", click "This computer"  ->  "D:"  ->  "Micropython_Codes"  ->  "14.2_AP_mode". and double click "AP_mode.py". 
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/14.2_AP_mode/AP_mode.py
    :language: python
    :dedent:
...
Open "Thonny", click "This computer"  ->  "D:"  ->  "Micropython_Codes"  ->  "14.3_AP+STA_mode"and double click "AP+STA_mode.py". 
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/14.3_AP+STA_mode/AP+STA_mode.py
    :language: python
    :dedent:
