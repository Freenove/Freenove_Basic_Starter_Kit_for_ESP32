...
In the new popup window, select corresponding "USB-SERIAL CH340 (COM3)" for port. Click "Browse", select " **16.1_Camera_WebServer\firmware\micropython_camera_feeeb5ea3_esp32_idf4_4.bin** ".
...
Open "Thonny", click "This computer" **->** "D:" **->** "Micropython_Codes" **->** "16.1_Camera_WebServer". Select folder **"lib"**, right click your mouse to select "Upload to /", wait for **"lib"** to be uploaded to ESP32-WROVER and then double click **"picoweb_video.py"**.
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/16.1_Camera_WebServer/picoweb_video.py
    :linenos:
    :language: python
    :dedent:
...
.. :linenos:iteralinclude:: ../../../freenove_Kit/Python/Python_Codes/16.1_Camera_WebServer/picoweb_video.py
    :linenos:
    :language: python
    :lines: 105-113
    :dedent:
