...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/15.1_TCP_as_Client/TCP_as_Client.py
    :linenos:
    :language: python
    :dedent:
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/15.2_TCP_as_Server/TCP_as_Server.py
    :linenos:
    :language: python
    :dedent:
