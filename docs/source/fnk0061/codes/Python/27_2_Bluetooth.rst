...
Open "Thonny", click "This computer"  ->  "D:"  ->  "Micropython_Codes"  ->  "13.2_ BLE_LED". Select "ble_advertising.py", right click your mouse to select "Upload to /", wait for "ble_advertising.py" to be uploaded to ESP32-WROVER and then double click "BLE_LED.py".
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/13.2_BLE_LED/BLE_LED.py
    :language: python
    :dedent:
